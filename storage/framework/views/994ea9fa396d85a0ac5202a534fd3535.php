...
<?php $__env->startSection('title', 'Tambah OLT'); ?>

<?php $__env->startSection('page-title', 'Tambah OLT Baru'); ?>
...
<form action="<?php echo e(route('admin.olts.store')); ?>" method="POST" id="form-olt">
    <?php echo csrf_field(); ?>
    
    <!-- Hidden fields for identified data -->
    <input type="hidden" name="brand" id="input_brand" value="<?php echo e(old('brand')); ?>">
    <input type="hidden" name="model" id="input_model" value="<?php echo e(old('model')); ?>">
    <input type="hidden" name="total_pon_ports" id="input_pon_ports" value="<?php echo e(old('total_pon_ports')); ?>">
    <input type="hidden" name="total_uplink_ports" id="input_uplink_ports" value="<?php echo e(old('total_uplink_ports')); ?>">
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <option value="<?php echo e($pop->id); ?>" <?php echo e(old('pop_id', $popId) == $pop->id ? 'selected' : ''); ?>>
                                <?php echo e($pop->name); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="ip_address" id="ip_address" 
                               class="form-control <?php $__errorArgs = ['ip_address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                               value="<?php echo e(old('ip_address')); ?>" required placeholder="192.168.1.1">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="snmp_port" id="snmp_port" class="form-control" 
                                           value="<?php echo e(old('snmp_port', 161)); ?>" min="1" max="65535">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="snmp_community" id="snmp_community" class="form-control" 
                                           value="<?php echo e(old('snmp_community', 'public')); ?>" placeholder="public">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="telnet_port" id="telnet_port" class="form-control" 
                                           value="<?php echo e(old('telnet_port', 23)); ?>">
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="telnet_username" id="telnet_username" class="form-control" 
                                           value="<?php echo e(old('telnet_username')); ?>" placeholder="admin">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="ssh_port" id="ssh_port" class="form-control" 
                                           value="<?php echo e(old('ssh_port', 22)); ?>">
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ssh_username" id="ssh_username" class="form-control" 
                                           value="<?php echo e(old('ssh_username')); ?>" placeholder="admin">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="latitude" id="latitude" class="form-control" 
                                       value="<?php echo e(old('latitude')); ?>" placeholder="-6.2088">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="longitude" id="longitude" class="form-control" 
                                       value="<?php echo e(old('longitude')); ?>" placeholder="106.8456">
                            </div>
                        </div>
                    </div>
...
unset($__errorArgs, $__bag); ?>" 
                               value="<?php echo e(old('name')); ?>" required placeholder="Contoh: OLT-DESA-A">
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="<?php echo e($router->id); ?>" <?php echo e(old('router_id') == $router->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projek\internet35\resources\views/admin/olts/create.blade.php ENDPATH**/ ?>