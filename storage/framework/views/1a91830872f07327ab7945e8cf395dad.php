...
<?php $__env->startSection('title', 'Detail ONU - ' . ($onu->name ?? $onu->serial_number)); ?>

<?php $__env->startSection('page-title', 'Detail ONU: ' . ($onu->name ?? $onu->serial_number)); ?>

<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>">Dashboard</a></li>
    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.onus.index')); ?>">ONU</a></li>
    <li class="breadcrumb-item active"><?php echo e($onu->name ?? $onu->serial_number); ?></li>
    ...
    <div class="col-lg-4">
        ...
        <div class="card card-widget widget-user-2 shadow">
            <div class="widget-user-header bg-<?php echo e($onu->status == 'online' ? 'success' : ($onu->status == 'los' ? 'warning' : 'danger')); ?>">
                ...
                <h3 class="widget-user-username"><?php echo e($onu->name ?? 'ONU'); ?></h3>
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <span class="nav-link">
                            Distance
                            <span class="float-right">
                                <?php echo e($onu->distance ? number_format($onu->distance, 2) . ' km' : '-'); ?>
            ...
            <div class="card-body p-0">
                <table class="table table-striped mb-0">
                    ...
                    <tr>
                        ...
                        <td><?php echo e($onu->pon_port); ?></td>
                    </tr>
                    <tr>
                        <td><strong>ONU Number</strong></td>
                        <td><?php echo e($onu->onu_number); ?></td>
                    </tr>
                    <tr>
