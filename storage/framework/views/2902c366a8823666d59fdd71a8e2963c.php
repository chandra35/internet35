...
<head>
    ...
    <title>Login | <?php echo e(config('app.name', 'Internet35')); ?></title>
...
<body class="hold-transition login-page">
    ...
    <div class="login-box">
        <div class="login-logo">
            <img src="<?php echo e(asset('assets/img/logo.png')); ?>" alt="Logo" class="img-fluid" onerror="this.style.display='none'">
            <a href="<?php echo e(route('landing')); ?>"><b>Internet</b>35</a>
        </div>
...
unset($__errorArgs, $__bag); ?>" 
                               placeholder="Email atau ID Pelanggan" value="<?php echo e(old('login')); ?>" required autofocus>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="login-footer">
            <p>&copy; <?php echo e(date('Y')); ?> Internet35. All rights reserved.</p>
            <p><a href="<?php echo e(route('landing')); ?>"><i class="fas fa-arrow-left mr-1"></i> Kembali ke Website</a></p>
        </div>
    </div>
...
<?php /**PATH D:\projek\internet35\resources\views/auth/login.blade.php ENDPATH**/ ?>