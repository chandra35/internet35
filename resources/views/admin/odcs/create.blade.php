...
@section('content')
<form action="{{ route('admin.odcs.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
            ...
            <div class="card card-secondary">
                ...
                <div class="card-body">
                    <div class="form-group mb-0">
                        ...
                        @enderror
                        <small class="text-muted">Format: JPG, PNG, WebP. Maks 5MB per foto. Maks 10 foto.</small>
                    </div>
