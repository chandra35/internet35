            ...
            <div class="col-lg-3 col-6">
                <div class="info-box stats-card">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number" id="statRouters">-</span>
                        <small class="text-muted"><span id="statRoutersCoords">-</span> dengan koordinat</small>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-6">
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="legend-item">
                            <div class="legend-icon"><i class="fas fa-server text-primary"></i></div>
                            <span>Router</span>
                        </div>
                        <div class="legend-item">
...
$(function() {
    ...
    function loadStats() {
        $.get('{{ route("admin.network-map.stats") }}', {
            ...
            $('#statRouters').text(data.routers.total);
            $('#statRoutersCoords').text(data.routers.with_coords);
