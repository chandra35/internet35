...
<link href="/Cuscss/english/frame.css?2024070613103468553184798" rel="stylesheet" type="text/css" />
<link href="/Cuscss/english/index.css?2024070613103468553184798" rel="stylesheet" type="text/css" />
<script src="/resource/common/jquery.min.js?2024070613103468553184798" type="text/javascript"></script>
<script src="/resource/common/util.js?2024070613103468553184798" type="text/javascript" ></script>
<script src="/frameaspdes/english/ssmpdes.js?2024070613103468553184798" language="JavaScript"></script>
<script src="/Cusjs/frame.asp?2024070613103468553184798" type="text/javascript"></script>
<style>
...
var xdPonSupport = "0";
var IsSupportWifi = '1';
var UserName = 'telecomadmin';
var ConfigFlag = '1#0';
var curUserType = '0';
var sysUserType = '0';
var dbaa1SuperSysUserType = '2';
var qvdtvdfSuperSysUserType = '2';
var IsModifiedPwd = '0';
var flagTips = true;
var timeout = null;
...
var curChangeMode = '0'; 
var apghnfeature = '0';
var videomodefeature = '0';
var fVideoCoverEnable = '0';
var DirectGuideFlag = '0';
var UnSupportGuide = '0';
var menuJsonData;
...
var autoadapt = '0';
var adaptResult = '0';
var appUrl = 'http://www.huawei.com/appdownload/linkhome/index.htm';
...
var fttrFlag = '0';
var guidewizardflag = '0';
var supportPrivacyStatement = "0";
var showPrivacyStatement = '1';
var curUserInfoStatus = '2';
var cfgFtWordArea = 'NOCHOOSE';
var ProvinceArray = '';
var defaultLang = 'english';
var languageList = 'english';
var supportChangeLang = '0';
var webLogo = '';
var isNotSupportGuide = '0';
var pwdChangeNoticeFlag  = '0';
var needToChangePwd = '';
...
var UserInfo = new Array(new stNormalUserInfo("telecomadmin", "0", "2"),null);;
...
{
    if ((DBAA1 == "1") || (CfgMode.toUpperCase() == 'DQATVDF2WIFI')) {
...
var wifiCodeFlag = '0';
function JumpALBANIAVDF2GuidePage() {
    if ((curUserType == 1) && ((IsModifiedPwd == '0') || (wifiCodeFlag == '0'))) {
        window.location="/CustomApp/userguideframe.asp";
    }
}
...
function gotoGuidePage() {
    ...
    if ((curUserType == qvdtvdfSuperSysUserType) && (CfgMode.toUpperCase() == 'DQATVDF2WIFI') &&
        (!parseInt(ConfigFlag.split("#")[2], 10))) {
        window.location="/CustomApp/adminguideframe.asp";
    } else if(((curUserType == sysUserType && 0 == DirectGuideFlag) && !parseInt(ConfigFlag.split("#")[0], 10)) ||
    ...
    if (CfgMode.toUpperCase() == 'ALBANIAVDF2') {
        JumpALBANIAVDF2GuidePage();
    }
}
...
function loadframe()
{
    ...
    if(parseInt(mngttype, 10) != 1)
    {
        if(parseInt(logo_singtel, 10) != 1)
        {
            ...
            if (CfgMode.toUpperCase() == 'ALBANIAVDF2') {
                $("#headerbrandlog").css("background", "url(../../../images/hwlog_vdf.jpg) no-repeat center");
                $("#headerbrandlog").css("width", "60px");
                $("#headerbrandlog").css("height", "50px");
            }
            ...
            if ((CfgMode.toUpperCase() == 'TS2') || (CfgMode.toUpperCase() == 'TS') || (CfgMode.toUpperCase() == 'TS2WIFI')) {
                $("#headerbrandlog").css("background", "none");
                $("#headerProductName").css("background", "url(../images/logo_ts.jpg) no-repeat left");
                $("#headerProductName").css("background-size", "30%");
                $("#headerProductName").css("text-indent", "50px");
            }
        }
        else
        {   
	...
	document.write('<div id="headerbg">');
        ...
        <script>
            if (logo_singtel == true) {
                ...
                document.write('<div style="margin: 0 auto">' + '<div style="height:18px"></div>'+'<img id="brandlog_paraguaypsn" src="images/hwlogo_paraguaypsn.gif" width="240px" height="28px"></img>' + '<div  id="headerProductNameParaguaypsn">' + ProductName + '</div>'+'</div>');
            } else if (CfgMode.toUpperCase() == 'MYTIME') {
            ...
            <div class="wrapper-status" id="ontstatusinfo" style="display:none; width: 75%;">
                ...
                <input class="controler-opticSignal" id="opticSignal" type="radio" onclick="InitOpticInfo();" name="controler-status">
                ...
                <ul class="holder-status">
                    ...
                    <li class="opticSignal">
                        <label class="icon-opticSignal" for="opticSignal">&#xe900;</label>
                        <dl>
			...
			<div><input type="hidden" name="onttoken" id="onttoken" value="345e680a50d06266305e517e2662f8a5efb320734def19e25a090605e0db6d0a"></div>
                <div id="cmodeLogout" >
                    <span id="modechangeText" class="HeaderSpanTextGuide" onclick="showCmodePage();"  BindText="mainpage019"></span>
                </div>
...
function CreateThirdMenu(htmlTagId, parentId, parentPath, subMenus)
{
    ...
    for (var i in subMenus)
    {
        ...
        if ((CfgMode.toUpperCase() == 'NOVATEL2') && (isWanAccess == '1') && (subMenus[i].name == "Remote Mirror")) {
            continue;
        }
...
if (CfgMode.toUpperCase() == 'TTNET2') {
    var needJumpToWlan = '0'
    function GetWlanBeaconType()
    {
        $.ajax({
            type : "POST",
            async : false,
            cache : false,
            url : "./wlansafemode.asp",
            success : function(data) {
                needJumpToWlan = eval(data);
            },
            complete: function (XHR, TS) {
                XHR = null;
            }
    ...
    GetWlanBeaconType();
    if (needJumpToWlan == '1') {
        onMenuChange1("wlan5basic", "/html/amp/wlanbasic/WlanBasic.asp?5G");
    }
}
