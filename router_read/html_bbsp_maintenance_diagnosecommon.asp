...
<script language="javascript" src="../common/page.html?2024070613103468553184798"></script>
<script language="javascript" src="../common/wan_check.asp"></script>
<script language="JavaScript" src="../../../resource/lancutdes.js?20240706131034685531847982700422019"></script>
...
var titleColorRef = "red";
if (CfgModeWord === 'DESKAPASTRO') {
    titleColorRef = "#333333";
}
...
var PingResultList = new Array(new PingResultClass("InternetGatewayDevice.IPPingDiagnostics","None","","","4","10000","56","0","0","0","0","0","0"),null);
var PingResult = PingResultList[0];
var TracertResultList = new Array(new TracertResultClass("InternetGatewayDevice.TraceRouteDiagnostics","None","","","3","120000","38","0","30","0","0","0"),null);
...
var maptableInfo = new Array(null);
...
var aliasInterfaceList = new Array(null);
...
function LoadFrame()
{
    ...
    if ((IsPTVDFFlag == 1) ||  (CfgModeWord == "NOVATEL2")) {
    ...
    if (CfgModeWord === 'DESKAPASTRO') {
        ...
        $("#EquipCheck").css("width", "283px");
        $("#equipTestResult, #PingTestTitle").css("padding-bottom", "5px");
    ...
    if (IsAdminUser() == true)
    {
        ...
        else
        {
            if (IsSupportBridgeWan == 1)
            {
                ...
                setNoEncodeInnerHtmlValue("DCpingtitle_content", diagnose_language["bbsp_diagnose_titleadmin_astro"] + '<br><br>' + diagnose_language["bbsp_diagnose_title1_astro"]);
            }
            else
            {
...
<table width="100%" border="0" cellpadding="0" id="table_ping_title" cellspacing="0" class="func_title" style="display:none;"> 
  <tr> 
    ...
    <td>
        <input type="hidden" name="onttoken" id="hwonttoken" value="583dfe2a8ac9f7df6ff2f044c0c707efeab2ca522d8ff1f42c5b408321f84c4e"> 
    </td>
  </tr> 
</table> 
